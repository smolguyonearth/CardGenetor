...
function exportCardPNG(filename, btnElement, originalText) {
    ...
    // Save the original body background and make it transparent for the capture
    ...
    const originalBoxShadow = cardOuter ? cardOuter.style.boxShadow : '';
    ...
    .then(function (canvas) {
        ...
        if (cardOuter) cardOuter.style.boxShadow = originalBoxShadow;
